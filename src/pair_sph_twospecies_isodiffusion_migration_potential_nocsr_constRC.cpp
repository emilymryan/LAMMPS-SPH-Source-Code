...
PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC(LAMMPS *lmp) : Pair(lmp)
{
  restartinfo = 0;
  ...
  if (icA < 0)
    error->all(FLERR,
	       "Can't find property cA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  cA = atom->dvector[icA];
  ...
  if (idcA < 0)
    error->all(FLERR,
	       "Can't find property dcA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (icC < 0)
    error->all(FLERR,
	       "Can't find property cC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  cC = atom->dvector[icC];
  ...
  if (idcC < 0)
    error->all(FLERR,
	       "Can't find property dcC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (imuA < 0)
    error->all(FLERR,
	       "Can't find property muA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (imuC < 0)
    error->all(FLERR,
	       "Can't find property muC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (iDA < 0)
    error->all(FLERR,
	       "Can't find property DA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  DA = atom->dvector[iDA];
  ...
  if (iDC < 0)
    error->all(FLERR,
	       "Can't find property DC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  DC = atom->dvector[iDC];
  ...
  if (imM < 0)
    error->all(FLERR,
	       "Can't find property mM for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  mM = atom->dvector[imM];
  ...
  if (idmM < 0)
    error->all(FLERR,
	       "Can't find property dmM for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (ilocal_pot < 0)
    error->all(FLERR,
	       "Can't find property local_pot for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (inext_local_pot < 0)
    error->all(FLERR,
	       "Can't find property next_local_pot for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (inx < 0)
    error->all(FLERR,
	       "Can't find property nx for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  nx = atom->dvector[inx];
  ...
  if (idnx < 0)
    error->all(FLERR,
	       "Can't find property dnx for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (iny < 0)
    error->all(FLERR,
	       "Can't find property ny for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ny = atom->dvector[iny];
  ...
  if (idny < 0)
    error->all(FLERR,
	       "Can't find property dny for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  ...
  if (inz < 0)
    error->all(FLERR,
	       "Can't find property nz for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
  nz = atom->dvector[inz];
  ...
  if (idnz < 0)
    error->all(FLERR,
	       "Can't find property dnz for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
...
PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::~PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC() {
  if (allocated) {
...
/* ---------------------------------------------------------------------- */
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::init_style()
{
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::compute(int eflag, int vflag) {
  ...
  for (ii = 0; ii < inum; ii++) {
	...
	if ((itype==1) && (jtype==1)) { // fluid-fluid interaction outside of flux
	  ...
	  // Anion diffusion
	  deltaDcA = (1.0/(imass*r))*(DA[i]*ni*imass + DA[j]*nj*jmass)/(ni*nj) * (cA[i] - cA[j])*wfd; // check kernal and see if divided by r
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::allocate() {
  allocated = 1;
  int n = atom->ntypes;
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::settings(int narg, char **arg) {
  if (narg != 0)
    error->all(FLERR,
	       "Illegal number of setting arguments for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
}
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::coeff(int narg, char **arg) {
  if (narg != 10)
    error->all(FLERR,"Incorrect number of args for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr/constrc  coefficients");
  if (!allocated)
    allocate();
  ...
  if (count == 0)
    error->all(FLERR,"Incorrect args for pair coefficients sph/twospecies/isodiffusion/migration/potential/nocsr/constrc");
}
...
double PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::init_one(int i, int j) {

  if (setflag[i][j] == 0) {
    error->all(FLERR,"All pair sph/twospecies/isodiffusion/migration/potential/nocsr/constrc coeffs are not set");
  }
...
double PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::single(int i, int j, int itype, int jtype,
...
int PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::pack_forward_comm(int n, int *list, double *buf,
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::unpack_forward_comm(int n, int first, double *buf)
{
  int i, m, last;
  m = 0;
  last = first + n;
...
int PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
  m = 0;
  last = first + n;
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSRConstRC::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
  m = 0;
  for (i = 0; i < n; i++) {
