...
PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC(LAMMPS *lmp) : Pair(lmp)
{
  restartinfo = 0;
  ...
  if (iDAx < 0)
    error->all(FLERR,
	       "Can't find property DAx for pair_style sph/twospecies/anisodiffusion/migration/potential/csr/constrc");
  ...
  if (iDAy < 0)
    error->all(FLERR,
	       "Can't find property DAy for pair_style sph/twospecies/anisodiffusion/migration/potential/csr/constrc");
  ...
  if (iDCx < 0)
    error->all(FLERR,
	       "Can't find property DCx for pair_style sph/twospecies/anisodiffusion/migration/potential/csr/constrc");
  ...
  if (iDCy < 0)
    error->all(FLERR,
	       "Can't find property DCy for pair_style sph/twospecies/anisodiffusion/migration/potential/csr/constrc");
  ...
  if (idnx < 0)
    error->all(FLERR,
	       "Can't find property dnx for pair_style sph/twospecies/anisodiffusion/migration/potential/csr/constrc");
  ...
  if (idny < 0)
    error->all(FLERR,
	       "Can't find property dny for pair_style sph/twospecies/anisodiffusion/migration/potential/csr/constrc");
  ...
  if (idnz < 0)
    error->all(FLERR,
	       "Can't find property dnz for pair_style sph/twospecies/anisodiffusion/migration/potential/csr/constrc");
...
PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::~PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC() {
  if (allocated) {
...
/* ---------------------------------------------------------------------- */
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::init_style()
{
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::compute(int eflag, int vflag) {
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::allocate() {
  allocated = 1;
  int n = atom->ntypes;
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::settings(int narg, char **arg) {
  if (narg != 0)
    error->all(FLERR,
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::coeff(int narg, char **arg) {
  if (narg != 10)
...
double PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::init_one(int i, int j) {
...
double PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::single(int i, int j, int itype, int jtype,
...
int PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::pack_forward_comm(int n, int *list, double *buf,
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::unpack_forward_comm(int n, int first, double *buf)
{
  int i, m, last;
  m = 0;
  last = first + n;
...
int PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
  m = 0;
  last = first + n;
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSRConstRC::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
  m = 0;
  for (i = 0; i < n; i++) {
