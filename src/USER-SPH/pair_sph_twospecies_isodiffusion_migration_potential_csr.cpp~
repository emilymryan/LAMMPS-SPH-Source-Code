...
PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR(LAMMPS *lmp) : Pair(lmp)
{
  restartinfo = 0;
  ...
  if (icA < 0)
    error->all(FLERR,
	       "Can't find property cA for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  cA = atom->dvector[icA];
  ...
  if (idcA < 0)
    error->all(FLERR,
	       "Can't find property dcA for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (icC < 0)
    error->all(FLERR,
	       "Can't find property cC for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  cC = atom->dvector[icC];
  ...
  if (idcC < 0)
    error->all(FLERR,
	       "Can't find property dcC for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (imuA < 0)
    error->all(FLERR,
	       "Can't find property muA for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (imuC < 0)
    error->all(FLERR,
	       "Can't find property muC for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (iDAx < 0)
    error->all(FLERR,
	       "Can't find property DAx for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (iDAy < 0)
    error->all(FLERR,
	       "Can't find property DAy for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (iDCx < 0)
    error->all(FLERR,
	       "Can't find property DCx for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (iDCy < 0)
    error->all(FLERR,
	       "Can't find property DCy for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (iRC < 0)
    error->all(FLERR,
	       "Can't find property RC for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  RC = atom->dvector[iRC];
  ...
  if (imM < 0)
    error->all(FLERR,
	       "Can't find property mM for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  mM = atom->dvector[imM];
  ...
  if (idmM < 0)
    error->all(FLERR,
	       "Can't find property dmM for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (ilocal_pot < 0)
    error->all(FLERR,
	       "Can't find property local_pot for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (inext_local_pot < 0)
    error->all(FLERR,
	       "Can't find property next_local_pot for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (inx < 0)
    error->all(FLERR,
	       "Can't find property nx for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  nx = atom->dvector[inx];
  ...
  if (idnx < 0)
    error->all(FLERR,
	       "Can't find property dnx for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (iny < 0)
    error->all(FLERR,
	       "Can't find property ny for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ny = atom->dvector[iny];
  ...
  if (idny < 0)
    error->all(FLERR,
	       "Can't find property dny for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  ...
  if (inz < 0)
    error->all(FLERR,
	       "Can't find property nz for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
  nz = atom->dvector[inz];
  ...
  if (idnz < 0)
    error->all(FLERR,
	       "Can't find property dnz for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
...
PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::~PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR() {
  if (allocated) {
...
/* ---------------------------------------------------------------------- */
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::init_style()
{
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::compute(int eflag, int vflag) {
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::allocate() {
  allocated = 1;
  int n = atom->ntypes;
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::settings(int narg, char **arg) {
  if (narg != 0)
    error->all(FLERR,
	       "Illegal number of setting arguments for pair_style sph/twospecies/anisodiffusion/migration/potential/csr");
}
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::coeff(int narg, char **arg) {
  if (narg != 9)
    error->all(FLERR,"Incorrect number of args for pair_style sph/twospecies/anisodiffusion/migration/potential/csr  coefficients");
  if (!allocated)
    allocate();
  ...
  if (count == 0)
    error->all(FLERR,"Incorrect args for pair coefficients sph/twospecies/anisodiffusion/migration/potential/csr");
}
...
double PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::init_one(int i, int j) {

  if (setflag[i][j] == 0) {
    error->all(FLERR,"All pair sph/twospecies/anisodiffusion/migration/potential/csr coeffs are not set");
  }
...
double PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::single(int i, int j, int itype, int jtype,
...
int PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::pack_forward_comm(int n, int *list, double *buf,
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::unpack_forward_comm(int n, int first, double *buf)
{
  int i, m, last;
  m = 0;
  last = first + n;
...
int PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
  m = 0;
  last = first + n;
...
void PairSPHTwospeciesAnisodiffusionMigrationPotentialCSR::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
  m = 0;
  for (i = 0; i < n; i++) {
