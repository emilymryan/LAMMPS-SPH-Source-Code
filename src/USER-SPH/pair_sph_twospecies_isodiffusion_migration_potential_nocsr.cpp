...
PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR(LAMMPS *lmp) : Pair(lmp)
{
  restartinfo = 0;
  ...
  if (icA < 0)
    error->all(FLERR,
	       "Can't find property cA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  cA = atom->dvector[icA];
  ...
  if (idcA < 0)
    error->all(FLERR,
	       "Can't find property dcA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (icC < 0)
    error->all(FLERR,
	       "Can't find property cC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  cC = atom->dvector[icC];
  ...
  if (idcC < 0)
    error->all(FLERR,
	       "Can't find property dcC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (imuA < 0)
    error->all(FLERR,
	       "Can't find property muA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (imuC < 0)
    error->all(FLERR,
	       "Can't find property muC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (iDA < 0)
    error->all(FLERR,
	       "Can't find property DA for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  DA = atom->dvector[iDA];
  ...
  if (iDC < 0)
    error->all(FLERR,
	       "Can't find property DC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  DC = atom->dvector[iDC];
  ...
  if (iRC < 0)
    error->all(FLERR,
	       "Can't find property RC for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  RC = atom->dvector[iRC];
  ...
  if (imM < 0)
    error->all(FLERR,
	       "Can't find property mM for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  mM = atom->dvector[imM];
  ...
  if (idmM < 0)
    error->all(FLERR,
	       "Can't find property dmM for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (ilocal_pot < 0)
    error->all(FLERR,
	       "Can't find property local_pot for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (inext_local_pot < 0)
    error->all(FLERR,
	       "Can't find property next_local_pot for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (inx < 0)
    error->all(FLERR,
	       "Can't find property nx for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  nx = atom->dvector[inx];
  ...
  if (idnx < 0)
    error->all(FLERR,
	       "Can't find property dnx for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (iny < 0)
    error->all(FLERR,
	       "Can't find property ny for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ny = atom->dvector[iny];
  ...
  if (idny < 0)
    error->all(FLERR,
	       "Can't find property dny for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  ...
  if (inz < 0)
    error->all(FLERR,
	       "Can't find property nz for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
  nz = atom->dvector[inz];
  ...
  if (idnz < 0)
    error->all(FLERR,
	       "Can't find property dnz for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
...
PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::~PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR() {
  if (allocated) {
...
/* ---------------------------------------------------------------------- */
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::init_style()
{
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::compute(int eflag, int vflag) {
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::allocate() {
  allocated = 1;
  int n = atom->ntypes;
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::settings(int narg, char **arg) {
  if (narg != 0)
    error->all(FLERR,
	       "Illegal number of setting arguments for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr");
}
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::coeff(int narg, char **arg) {
  if (narg != 9)
    error->all(FLERR,"Incorrect number of args for pair_style sph/twospecies/isodiffusion/migration/potential/nocsr  coefficients");
  if (!allocated)
    allocate();
  ...
  if (count == 0)
    error->all(FLERR,"Incorrect args for pair coefficients sph/twospecies/isodiffusion/migration/potential/nocsr");
}
...
double PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::init_one(int i, int j) {

  if (setflag[i][j] == 0) {
    error->all(FLERR,"All pair sph/twospecies/isodiffusion/migration/potential/nocsr coeffs are not set");
  }
...
double PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::single(int i, int j, int itype, int jtype,
...
int PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::pack_forward_comm(int n, int *list, double *buf,
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::unpack_forward_comm(int n, int first, double *buf)
{
  int i, m, last;
  m = 0;
  last = first + n;
...
int PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
  m = 0;
  last = first + n;
...
void PairSPHTwospeciesIsodiffusionMigrationPotentialNoCSR::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
  m = 0;
  for (i = 0; i < n; i++) {
